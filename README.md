...
```usage.ipynb``` is an example on diabetic metabolic dysregulation due to genetic knockouts.
 ...
 Publication (preprint): [Subtypes of type 2 diabetes from genetic knockouts in HumanGEM genome-scale model show 5 signature metabolic states](diabetes_sysbio_draft_publication.pdf)
